...
const PLAYERS: PlayerSource[] = [
  ...
  sr('aramsdale',  'Aaron Ramsdale',  'GK', ['GK'], 79, '2022'),
  sr('pickford',  'Jordan Pickford', 'GK', ['GK'], 84, '2018, 2022, 2026'),
  sr('dhenderson', 'Dean Henderson',  'GK', ['GK'], 77, '2026'),
  sr('jtrafford',  'James Trafford',  'GK', ['GK'], 73, '2026'),
  ...
  sr('cwoods',    'Chris Woods',    'GK', ['GK'], 77, '1986, 1990'),
  sr('gbailey',   'Gary Bailey',    'GK', ['GK'], 75, '1986'),
  sr('dbeasant',  'Dave Beasant',   'GK', ['GK'], 74, '1990'),
  ...
  sr('djames',    'David James',    'GK', ['GK'], 75, '2002, 2006, 2010'),
  sr('jhart',     'Joe Hart',       'GK', ['GK'], 81, '2010, 2014'),
  sr('rgreen',    'Rob Green',      'GK', ['GK'], 75, '2010'),
  sr('fforster',  'Fraser Forster', 'GK', ['GK'], 75, '2014'),
  sr('bfoster',   'Ben Foster',     'GK', ['GK'], 76, '2014'),
  sr('npope',     'Nick Pope',      'GK', ['GK'], 79, '2018, 2022'),

  // ── RB ──────────────────────────────────────────────────────────────────────
  sr('gneville',  'Gary Neville',           'DEF', ['RB'], 85, '1998, 2006'),
  sr('gjohnson',  'Glen Johnson',           'DEF', ['RB'], 80, '2010, 2014'),
  sr('trippier',  'Kieran Trippier',        'DEF', ['RB'], 84, '2018, 2022'),
  sr('gcohen',    'George Cohen',           'DEF', ['RB'], 80, '1966'),
  sr('jarmfield', 'Jimmy Armfield',         'DEF', ['RB'], 80, '1962, 1966'),
  sr('knewton',   'Keith Newton',           'DEF', ['RB'], 78, '1970'),
  sr('twright',   'Tommy Wright',           'DEF', ['RB'], 76, '1970'),
  sr('mmills',    'Mick Mills',             'DEF', ['RB'], 76, '1982'),
  sr('pneal',     'Phil Neal',              'DEF', ['RB'], 82, '1982'),
  ...
  sr('dmills',    'Danny Mills',            'DEF', ['RB'], 74, '2002'),
  sr('kwalker',   'Kyle Walker',            'DEF', ['RB'], 84, '2018, 2022'),
  sr('bwhite',    'Ben White',              'DEF', ['RB'], 79, '2022'),
  sr('rjames',    'Reece James',            'DEF', ['RB'], 80, '2026'),
  sr('tlivramento','Toni Livramento',       'DEF', ['RB'], 79, '2026'),
  sr('dspence',   'Djed Spence',            'DEF', ['RB'], 73, '2026'),
  ...
  sr('mkeown',      'Martin Keown',     'DEF', ['CB'], 77, '1998, 2002'),
  sr('rioferd',     'Rio Ferdinand',   'DEF', ['CB'], 90, '1998, 2002, 2006'),
  ...
  sr('philthompson','Phil Thompson',   'DEF', ['CB'], 79, '1982'),
  sr('dwatson',     'Dave Watson',     'DEF', ['CB'], 76, '1982'),
  sr('sfoster',     'Steve Foster',    'DEF', ['CB'], 73, '1982'),
  sr('tfenwick',    'Terry Fenwick',   'DEF', ['CB'], 73, '1986'),
  ...
  sr('southgate',   'Gareth Southgate','DEF', ['CB'], 79, '1998, 2002'),
  ...
  sr('jstones',     'John Stones',     'DEF', ['CB'], 83, '2018, 2022, 2026'),
  sr('mguehi',      'Marc Guehi',      'DEF', ['CB'], 81, '2026'),
  sr('ekonsa',      'Ezri Konsa',      'DEF', ['CB'], 79, '2026'),
  sr('jquansah',    'Jarell Quansah',  'DEF', ['CB'], 76, '2026'),
  sr('dburn',       'Dan Burn',        'DEF', ['CB'], 74, '2026'),
  sr('hmaguire',    'Harry Maguire',   'DEF', ['CB'], 77, '2018, 2022'),
  sr('edier',       'Eric Dier',       'DEF', ['CB'], 77, '2018, 2022'),
  sr('ccoady',      'Conor Coady',     'DEF', ['CB'], 73, '2022'),
  ...
  sr('decrice',     'Declan Rice',     'MID', ['CM'], 88, '2022, 2026'),
  sr('nstiles',     'Nobby Stiles',    'MID', ['CM'], 80, '1966, 1970'),
  ...
  sr('amullery',    'Alan Mullery',    'MID', ['CM'], 79, '1970'),
  sr('cbell',       'Colin Bell',      'MID', ['CM'], 82, '1970'),
  sr('ehughes',     'Emlyn Hughes',    'MID', ['CM'], 78, '1970'),
  sr('tbrooking',   'Trevor Brooking', 'MID', ['CM'], 83, '1982'),
  ...
  sr('tmcdermott',  'Terry McDermott', 'MID', ['CM'], 77, '1982'),
  ...
  sr('gascoigne',   'Paul Gascoigne',  'MID', ['CM'], 89, '1990'),
  ...
  sr('gbarry',      'Gareth Barry',    'MID', ['CM'], 78, '2010'),
  sr('jmilner',     'James Milner',    'MID', ['CM'], 78, '2010, 2014'),
  sr('jwilshere',   'Jack Wilshere',   'MID', ['CM'], 79, '2014'),
  sr('rbarkley',    'Ross Barkley',    'MID', ['CM'], 76, '2014'),
  sr('alallana',    'Adam Lallana',    'MID', ['CM'], 78, '2014'),
  sr('jhenderson',  'Jordan Henderson','MID', ['CM'], 81, '2014, 2018, 2022, 2026'),
  sr('eanderson',   'Elliot Anderson', 'MID', ['CM'], 75, '2026'),
  sr('kmainoo',     'Kobbie Mainoo',   'MID', ['CM'], 82, '2026'),
  sr('mrogers',     'Morgan Rogers',   'MID', ['CM'], 78, '2026'),
  sr('eeze',        'Eberechi Eze',    'MID', ['CM'], 82, '2026'),
  sr('dalli',       'Dele Alli',       'MID', ['CM'], 79, '2018'),
  sr('rloftus',     'Ruben Loftus-Cheek', 'MID', ['CM'], 77, '2018'),
  sr('jbellingham', 'Jude Bellingham', 'MID', ['CM'], 90, '2022, 2026'),
  sr('mmount',      'Mason Mount',     'MID', ['CM'], 82, '2022'),
  sr('cgallagher',  'Conor Gallagher', 'MID', ['CM'], 76, '2022'),
  sr('jmaddison',   'James Maddison',  'MID', ['CM'], 83, '2022'),
  sr('kphillips',   'Kalvin Phillips', 'MID', ['CM'], 77, '2022'),

  // ── RW ──────────────────────────────────────────────────────────────────────
  sr('beckham',    'David Beckham',          'ATT', ['RW'], 89, '1998, 2002, 2006'),
  sr('danderton',  'Darren Anderton',        'ATT', ['RW'], 76, '1998'),
  sr('saka',       'Bukayo Saka',            'ATT', ['RW'], 89, '2022, 2026'),
  sr('nmadueke',   'Noni Madueke',           'ATT', ['RW'], 78, '2026'),
  ...
  // ── LW ──────────────────────────────────────────────────────────────────────
  sr('grix',          'Graham Rix',        'ATT', ['LW'], 74, '1982'),
  sr('johnbarnes',    'John Barnes',      'ATT', ['LW'], 88, '1986, 1990'),
  sr('sterling',      'Raheem Sterling',  'ATT', ['LW'], 88, '2014, 2018, 2022'),
  sr('rashford',      'Marcus Rashford',  'ATT', ['LW'], 87, '2018, 2022, 2026'),
  sr('agordon',       'Anthony Gordon',   'ATT', ['LW'], 82, '2026'),

  sr('pbeardsley',    'Peter Beardsley',  'ATT', ['LW'], 83, '1986, 1990'),
  sr('pmerson',       'Paul Merson',      'ATT', ['LW'], 75, '1998'),
  sr('smcmanaman',    'Steve McManaman',  'ATT', ['LW'], 78, '1998'),
  ...
  sr('kdixon',      'Kerry Dixon',       'ATT', ['ST'], 76, '1986'),
  ...
  sr('aclarke',     'Allan Clarke',       'ATT', ['ST'], 82, '1970'),
  sr('jastle',      'Jeff Astle',        'ATT', ['ST'], 73, '1970'),
  sr('flee',        'Francis Lee',       'ATT', ['ST'], 79, '1970'),
  sr('posgood',     'Peter Osgood',      'ATT', ['ST'], 75, '1970'),
  sr('kkeegan',     'Kevin Keegan',      'ATT', ['ST'], 87, '1982'),
  sr('tfrancis',    'Trevor Francis',    'ATT', ['ST'], 80, '1982'),
  sr('pmariner',    'Paul Mariner',      'ATT', ['ST'], 79, '1982'),
  ...
  sr('rfowler',     'Robbie Fowler',      'ATT', ['ST'], 80, '2002'),
  ...
  sr('hkane',       'Harry Kane',        'ATT', ['ST'], 91, '2018, 2022, 2026'),
  sr('owatkins',    'Ollie Watkins',     'ATT', ['ST'], 83, '2026'),
  sr('itoney',      'Ivan Toney',        'ATT', ['ST'], 79, '2026'),
