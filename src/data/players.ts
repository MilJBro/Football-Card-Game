...
const PLAYERS: PlayerSource[] = [
  ...
  sr('aramsdale',  'Aaron Ramsdale',  'GK', ['GK'], 83, '2022'),
  sr('pickford',  'Jordan Pickford', 'GK', ['GK'], 86, '2018, 2022, 2026'),
  sr('dhenderson', 'Dean Henderson',  'GK', ['GK'], 79, '2026'),
  sr('jtrafford',  'James Trafford',  'GK', ['GK'], 76, '2026'),
  ...
  sr('fforster',  'Fraser Forster', 'GK', ['GK'], 78, '2014'),
