...
const PLAYERS: PlayerSource[] = [
  ...
  sr('bonetti',   'Peter Bonetti',  'GK', ['GK'], 78, '1970'),
  sr('rspringett','Ron Springett',  'GK', ['GK'], 73, '1962, 1966'),
  sr('gwest',     'Gordon West',    'GK', ['GK'], 74, '1966'),
  ...
  sr('blabone',     'Brian Labone',    'DEF', ['CB'], 78, '1966, 1970'),
  sr('rflowers',    'Ron Flowers',     'DEF', ['CB'], 75, '1958, 1962'),
  ...
  sr('rwilson',     'Ray Wilson',      'DEF', ['LB'], 82, '1966'),
  ...
  sr('peterthompson', 'Peter Thompson',   'ATT', ['LW'], 73, '1966'),
  ...
  sr('jgreaves',    'Jimmy Greaves',     'ATT', ['ST'], 85, '1966'),
