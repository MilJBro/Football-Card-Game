...
> = {
  GK: {
    bg: 'bg-gradient-to-b from-emerald-900/70 to-pitch-dark',
    border: 'border-emerald-400',
    ring: 'ring-emerald-400',
    posBadge: 'bg-emerald-600',
    glow: 'shadow-[0_0_18px_rgba(60,172,59,0.45)]',
  },
  DEF: {
    bg: 'bg-gradient-to-b from-[#0d1f3a] to-pitch-dark',
    border: 'border-pl-cyan',
    ring: 'ring-pl-cyan',
    posBadge: 'bg-blue-700',
    glow: 'shadow-[0_0_18px_rgba(122,174,247,0.45)]',
  },
  MID: {
    bg: 'bg-gradient-to-b from-[#0d1f3a] to-pitch-dark',
    border: 'border-pl-cyan',
  ...
  ATT: {
    bg: 'bg-gradient-to-b from-red-950/80 to-pitch-dark',
    border: 'border-pl-pink',
    ring: 'ring-pl-pink',
    posBadge: 'bg-red-700',
    glow: 'shadow-[0_0_18px_rgba(230,29,37,0.45)]',
  },
};
